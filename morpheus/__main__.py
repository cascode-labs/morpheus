...
from morpheus.CadenceManager import cadenceManager, get_terminal_cwd
    ...
    try:
        ...
        while attempts < 10:
            try:
                ...
                UnixCommands(ws,args) #move and instead use consistant ws command
                break;
            except RuntimeError: #id is not ready yet wait 5 seconds
                sleep(5)
                attempts += 1
